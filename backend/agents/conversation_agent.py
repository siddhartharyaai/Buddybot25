...
class ConversationAgent:
    ...
    def __init__(self, gemini_api_key: str):
        ...
        self.template_variables = {
            ...
            "ability": ["hear very well", "see in the dark", "swim very fast", "climb tall trees", "fly high", "run quickly", "jump far", "dig deep holes", "find food easily", "make beautiful sounds"],
            ...
            "baby_name": ["puppy", "kitten", "chick", "cub", "calf", "foal", "lamb", "piglet", "duckling", "gosling", "fawn", "kit", "pup"],
